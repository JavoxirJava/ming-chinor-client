                    ...
                    {Array.isArray(displayProducts) &&  displayProducts.length > 0 && displayProducts.map((product) => (
                        ...
                        >
                            <div
                                ...
                                <Image
                                    src={`https://ming-chinor.javohir-dev.uz/uploads/${product.image}`}
                                    alt={product.name}
                                    width={120}
                                    height={120}
            ...
            <div className="w-full mt-6 h-[5vh] mb-6 flex justify-center">
                {visibleCount < products.length && (
                    <button
                        ...
                        className="bg-yellow-600 text-white px-6 py-1 rounded-full text-sm font-medium hover:bg-yellow-900 transition"
                    >
                        Yana ko‘rish
                    </button>
                )}
            ...
            {selectedProduct && (
                <div
                    ...
                    <div className="flex justify-center w-full">
                        <div
                            className="w-[300px] h-[200px] rounded-md overflow-hidden flex justify-center items-center mb-6 bg-gray-100">
                            <Image
                                src={`https://ming-chinor.javohir-dev.uz/uploads/${selectedProduct.image}`}
